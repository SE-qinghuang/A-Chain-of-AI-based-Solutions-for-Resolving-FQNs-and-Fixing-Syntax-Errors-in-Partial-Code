...
java_dataset = "E:\All_Project\PCR-Extension\Experiment\AI_Chain.csv"

result_path = "AI_Chain_example_change.csv"

simplenameExtraction = "E:\All_Project\PCR-Extension\Experiment\Prompt\Prompt_For_Java_Simplename_Extraction.txt"

simplename2FQN = "E:\All_Project\PCR-Extension\Experiment\Prompt\Prompt_For_Java_Simplename_to_FQN.txt"

Error_Message_Enhance = "E:\All_Project\PCR-Extension\Experiment\Prompt\Prompt_For_Java_Error_Message_Enhance.txt"

code_fix = "E:\All_Project\PCR-Extension\Experiment\Prompt\Prompt_For_Java_Code_Fix.txt"
...
for index, row in tqdm.tqdm(df.iterrows()):
    ...
    if Error_Message == "True" or Error_Message == "can't decode error message":
        if Error_Message == "can't decode error message":
            df.loc[index, 'ERROR_For_With_import'] = "can't decode error message"
        else:
